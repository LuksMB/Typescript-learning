...
class MouseGamer extends Mouse{
    ...
    constructor(name: string, cores: string){
...
//9. Herança de interfaces/classes --> utilizado para criar métodos para aplicar em várias classes.
interface showTitle{
    itemTitle(): string
}
...
class TesteParameters{
    constructor (public name: string, private quant: number, private price: number){
        this.name = name;
        this.quant = quant;
        this.price = price;
    }
